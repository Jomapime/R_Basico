...
Con el paquete rmarkdown instalado puede crear un nuevo archivo con extensión .Rmd, para hacer esto debe ir a las opciones que aparecen arriba de la interfaz "Rstudio", dar click en las opciones "File" -> "New File" -> "R markdown". Luego de esto Rstudio le solicitará título, autor y formato de salida, ingrese en formato de salida html y de clic en **OK**. Si prefiere un pdf debe tener instalado **LATEX** en su equipo.

Lo primero es el encabezado de su informe el cuál contiene: título, autor, fecha y formato de salida. Además va a encontrar un primer código entre tíldes o en un "Chunk", dicho código debe estar en el encabezado de todos los documentos. 
