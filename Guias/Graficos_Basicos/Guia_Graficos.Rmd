...
barplot(tablacasados, xlab = "Estado civil", ylab = "Frecuencia absoluta", 
        col = c("yellow", "blue"), main = "Diagrama Barras con leyenda",
        ylim = c(0,1000), 
...
R también trae integradas algunas paletas de colores, para no escribir un color para cada barra se pueden usar estas paletas, en este caso se usará la paleta _rainbow_, y entre paréntesis se colocará el número de colores a utilizar, como son 10 barras para cada grupo entonces se pondrá 10 entre paréntesis.
