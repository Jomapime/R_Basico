...
Si usted  quiere mostrar los datos en frecuencia relativa o en términos porcentuales puede usar el argumento _freq = F_.  
...
hist(IQ, xlab = "Eje X", ylab = "Frecuencia Absoluta", col = "Blue", 
     main = "Histograma con 40 barras", freq = T, breaks = 40)
...
El primer argumento de este código es definir sobre cual variable se va a calcular la densidad, para ello se pone el argumento _density()_ y entre parentesis se va a colocar la variable. Con el argumento _lwd_ usted puede definir el tamaño o ancho de la curva. También está el argumento _lty_ 


```{r, fig.show="hold", out.width="50%", fig.height=5}

hist(IQ, freq = F, main = "Curva densidad", ylab = "Densidad", col = "blue")
